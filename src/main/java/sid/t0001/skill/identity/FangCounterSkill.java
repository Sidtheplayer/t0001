        ...
        public void onInitiate(SkillContainer container) {
            ...
            listener.addEventListener(EventType.TAKE_DAMAGE_EVENT_ATTACK, EVENT_UUID, (event) -> {
                ...
                if (!serverPlayer.level().isClientSide() && event.isParried()) {
                    command = "/photon fx photon:breakclash4 entity @s -0.95 0.35 0.6 0 0 0 0.95 0.95 0.95 0 true true none";

                }
                else{
                    command = "/photon fx photon:block entity @s 0 0.25 0 0 0 0 1 1 1 0 true true xrot";
                }
