...
public class NAmogusRenderer extends MobRenderer<Amogus, AmogusModel> {
    ...
    public NAmogusRenderer(EntityRendererProvider.Context p_174362_) {
        super(p_174362_, new AmogusModel(p_174362_.bakeLayer(AmogusModel.LAYER_LOCATION)), 0.5F);
        this.addLayer(new ItemInHandLayer<>(this, p_174362_.getItemInHandRenderer()));
    }
