...
public class DarknessEntityPatch extends MobPatch<DarknessEntity> {
    ...
    public static void initAttributes(EntityAttributeModificationEvent event) {
        event.add(t0001Entities.DARKNESS_ENTITY.get(), EpicFightAttributes.MAX_STRIKES.get(), 4.0D);
        event.add(t0001Entities.DARKNESS_ENTITY.get(), EpicFightAttributes.IMPACT.get(), 2.0D);
    }
