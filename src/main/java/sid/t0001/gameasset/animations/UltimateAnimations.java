...
public class UltimateAnimations {
    ...
    public static AnimationManager.AnimationAccessor<CounterBaitAnimation> ONE_INCH_COUNTER_BAIT;
    ...
    public static void build(AnimationManager.AnimationBuilder builder) {
        ...
        ONE_INCH_COUNTER = builder.nextAccessor("biped/skill/one_inch_counter/one_inch_counter", (accessor) -> new GrapplingAttackAnimation(0.51F, 1.5F, accessor, biped)
                        ...
                        .addProperty(AttackAnimationProperty.ENTITY_YROT_PROVIDER, MoveCoordFunctions.LOOK_DEST)
...
//                )
        ...
        ONE_INCH_COUNTER_HIT = builder.nextAccessor("biped/skill/one_inch_counter/one_inch_counter_hit", (accessor) -> new LongHitAnimation(0.12F, accessor, biped)
                ...
                .addProperty(AnimationProperty.ActionAnimationProperty.NO_GRAVITY_TIME, TimePairList.create(5.1F, 5.5F))
        ...
        ONE_INCH_COUNTER_BAIT = builder.nextAccessor("biped/skill/one_inch_counter/one_inch_bait", (accessor) ->
                new CounterBaitAnimation(
                        0.0F,  // convertTime
                        0.1F,  // antic
                        0.56F,  // preDelay
                        0.0F,  // contact
                        0.3F,  // recovery
                        0.1F,  // counterWindowStart
                        0.8F,  // counterWindowEnd
                        ColliderPreset.BIPED_BODY_COLLIDER,
                        biped.get().rootJoint,
                        accessor,
                        ONE_INCH_COUNTER_HIT,
                        ONE_INCH_COUNTER,
                        ONE_INCH_COUNTER_BAIT_FAIL,
                        biped
                )
                        ...
                        .addEvents(ActionAnimationProperty.ON_BEGIN_EVENTS, AnimationEvent.SimpleEvent.create((e, s, p) -> {
                            ...
                            new JointTrackedEntityEffect(menacing, l, eo, ea.rootJoint, Vec3f.ZERO, EntityEffect.AutoRotate.NONE, false).start();
                        }, AnimationEvent.Side.CLIENT))
