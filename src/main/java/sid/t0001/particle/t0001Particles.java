...
public class t0001Particles {
    ...
    public static final RegistryObject<HitParticleType> HIT_PARRY = PARTICLES.register("hit_parry", () -> new HitParticleType(true, HitParticleType.RANDOM_WITHIN_BOUNDING_BOX, HitParticleType.ZERO));
