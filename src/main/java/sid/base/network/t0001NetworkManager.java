...
import sid.base.network.command.*;
...
public class t0001NetworkManager {
    ...
    public static void register(final RegisterPayloadHandlersEvent event) {
        ...
        registrar.playToClient(EntityEmitterShapeEffectCommand.TYPE, EntityEmitterShapeEffectCommand.CODEC, EntityEmitterShapeEffectCommand::execute);
