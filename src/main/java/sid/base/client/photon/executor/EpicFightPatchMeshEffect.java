...
public class EpicFightPatchMeshEffect extends JointTrackedEntityEffect {

    public static Map<Entity, List<EpicFightPatchMeshEffect>> CACHE = new HashMap<>();
     ...
     */
    public EpicFightPatchMeshEffect(FX fx, Level level, Entity entity, Joint joint, Vec3f translation, AutoRotate autoRotate, boolean updateRotation) {
    ...
    public void updateFXObjectFrame(IFXObject fxObject, float partialTicks) {
        ...
        setEmitterModel(fxObject, partialTicks);


    }


    public void setEmitterModel(IFXObject fxObject, float dt){
        if(runtime != null) {
