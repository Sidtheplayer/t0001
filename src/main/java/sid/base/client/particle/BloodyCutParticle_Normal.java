...
public class BloodyCutParticle_Normal extends NoRenderParticle {


    protected BloodyCutParticle_Normal(ClientLevel level, double x, double y, double z) {
        super(level, x, y, z);
        ...
        FX bloodyCutFX = FXHelper.getFX(ResourceLocation.parse("photon:bloodycut_normal"));
        FXRuntime runtime;
        if (bloodyCutFX != null) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public @NotNull Particle createParticle(@NotNull SimpleParticleType simpleParticleType, @NotNull ClientLevel clientLevel, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            return new BloodyCutParticle_Normal(clientLevel,x,y,z);
        }
